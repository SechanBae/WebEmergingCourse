...
const logFunction=function(req,res,next){
        let reqDate=(new Date()).toString();
        let reqPath=req.path;
        let reqIP=req.ip;
        let reqQueryParams=JSON.stringify(req.query);
        let reqBody=JSON.stringify(req.body);
        let logString=reqDate+" "+reqPath+" "+reqIP+" "+reqQueryParams+" "+reqBody+"\n";
